		...
		$("#saveBtn").click(function () {
			$.ajax({
				...
				data : {
					...
					"appellation" : $.trim($("#create-appelation").val()),
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-appelation">
								  <option></option>
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody id="clueBody">
						...
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=d54804bf6c0c4fec97b6312364be7f54';">马云先生</a></td>
							<td>阿里巴巴</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
                        ...
                        <tr class="active">
                            <td><input type="checkbox" /></td>
                            <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detail.do?id=b4ca643f8ce348a09b3aa844d2216767';">王健林先生</a></td>
                            <td>万达集团</td>
                            <td>010-84846003</td>
                            <td>12345678901</td>
                            <td>广告</td>
